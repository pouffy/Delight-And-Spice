...
import pouffy.delightandspice.common.registry.ModItems;
import vectorwing.farmersdelight.common.registry.ModSounds;

import java.util.Random;

public class JalapenoBlock extends BushBlock implements BonemealableBlock
{
    public static final IntegerProperty AGE = BlockStateProperties.AGE_7;
    private static final int JALAPENO_BEARING_AGE = 7;
    ...
    public JalapenoBlock(Properties properties) {
        super(properties);
    ...
    public ItemStack getCloneItemStack(BlockGetter worldIn, BlockPos pos, BlockState state) {
        return new ItemStack(pouffy.delightandspice.common.registry.ModItems.JALAPENO_SEEDS.get());
    }
    ...
    public InteractionResult use(BlockState state, Level worldIn, BlockPos pos, Player player, InteractionHand handIn, BlockHitResult hit) {
        ...
        boolean isMature = age == JALAPENO_BEARING_AGE;
        if (!isMature && player.getItemInHand(handIn).getItem() == Items.BONE_MEAL) {
            ...
            worldIn.setBlock(pos, state.setValue(AGE, JALAPENO_BEARING_AGE - 2), 2);
